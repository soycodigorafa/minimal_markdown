...
class SnippetService {
    ...
    if (selectedText.isEmpty) {
      ...
      controller.value = TextEditingValue(
        ...
        selection: TextSelection.collapsed(
          offset: startPos + codePos + codeContent.length + 4, // +4 for the closing ```
        ),
      );
    }
  }
  ...
  void insertBlockquote(TextEditingController controller) {
    final selectedText = controller.selection.textInside(controller.text);
    final quoteText = selectedText.isNotEmpty ? selectedText : 'Blockquote text here';
    final snippet = selectedText.isNotEmpty 
    ...
    if (selectedText.isEmpty) {
      ...
      controller.value = TextEditingValue(
        text: newText,
        selection: TextSelection.collapsed(
          offset: startPos + snippet.length,
        ),
      );
    }
  }
